/** @public */
declare abstract class AbstractCursor<
  TSchema = any,
...
/** @public */
declare type ArrayElement<Type> = Type extends ReadonlyArray<infer Item> ? Item : never;
 ...
 * @public
 */
declare interface BSONSerializeOptions
 ...
 * @see https://www.mongodb.com/docs/manual/reference/change-events/
 */
declare interface ChangeStreamCreateIndexDocument
 ...
 */
declare interface ChangeStreamDeleteDocument<TSchema extends Document = Document>
  extends ChangeStreamDocumentCommon,
...
/** @public */
declare type ChangeStreamDocument<TSchema extends Document = Document> =
 ...
 * @see https://www.mongodb.com/docs/manual/reference/change-events/
 */
declare interface ChangeStreamDropIndexDocument
  extends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
    ChangeStreamDocumentOperationDescription {
  /** Describes the type of operation represented in this change notification */
 ...
 */
declare interface ChangeStreamInsertDocument<TSchema extends Document = Document>
  extends ChangeStreamDocumentCommon,
    ChangeStreamDocumentKey<TSchema>,
    ChangeStreamDocumentCollectionUUID {
  /** Describes the type of operation represented in this change notification */
 ...
 * @see https://www.mongodb.com/docs/manual/reference/change-events/
 */
declare interface ChangeStreamRefineCollectionShardKeyDocument
  extends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
    ChangeStreamDocumentOperationDescription {
  /** Describes the type of operation represented in this change notification */
 ...
 */
declare interface ChangeStreamReplaceDocument<TSchema extends Document = Document>
  extends ChangeStreamDocumentCommon,
    ChangeStreamDocumentKey<TSchema> {
  /** Describes the type of operation represented in this change notification */
 ...
 * @see https://www.mongodb.com/docs/manual/reference/change-events/
 */
declare interface ChangeStreamReshardCollectionDocument
  extends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
    ChangeStreamDocumentOperationDescription {
  /** Describes the type of operation represented in this change notification */
 ...
 * @see https://www.mongodb.com/docs/manual/reference/change-events/
 */
declare interface ChangeStreamShardCollectionDocument
  extends ChangeStreamDocumentCommon,
    ChangeStreamDocumentCollectionUUID,
    ChangeStreamDocumentOperationDescription {
  /** Describes the type of operation represented in this change notification */
 ...
 */
declare interface ChangeStreamUpdateDocument<TSchema extends Document = Document>
  extends ChangeStreamDocumentCommon,
    ChangeStreamDocumentKey<TSchema>,
    ChangeStreamDocumentCollectionUUID {
  /** Describes the type of operation represented in this change notification */
...
declare type EnhancedOmit<TRecordOrUnion, KeyUnion> = string extends keyof TRecordOrUnion
  ? TRecordOrUnion
 ...
 */
declare interface FindOptions<TSchema extends Document = Document> extends CommandOperationOptions {
 ...
 * @public
 */
declare class GridFSBucket extends TypedEventEmitter<GridFSBucketEvents> {
  /* Excluded from this release type: s */
  /**
 ...
 * @public
 */
declare class GridFSBucketReadStream extends Readable implements NodeJS.ReadableStream {
  /* Excluded from this release type: s */
  /**
   * An error occurred
   * @event
 ...
 * @public
 */
declare class GridFSBucketWriteStream extends Writable implements NodeJS.WritableStream {
  bucket: GridFSBucket;
...
/** @public */
declare const LEGAL_TCP_SOCKET_OPTIONS: readonly ["family", "hints", "localAddress", "localPort", "lookup"];
...
/** @public */
declare type MatchKeysAndValues<TSchema> = Readonly<
  {
 ...
 * @category Error
 */
declare class MongoAPIError extends MongoDriverError {
 ...
 * @category Error
 */
declare class MongoAWSError extends MongoRuntimeError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoBatchReExecutionError extends MongoAPIError {
  constructor(message?: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoBulkWriteError extends MongoServerError {
 ...
 * @category Error
 */
declare class MongoChangeStreamError extends MongoRuntimeError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoCompatibilityError extends MongoAPIError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoCursorExhaustedError extends MongoAPIError {
  constructor(message?: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoCursorInUseError extends MongoAPIError {
  constructor(message?: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoDecompressionError extends MongoRuntimeError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoDriverError extends MongoError {
  constructor(message: string);
  get name(): string;
}
...
/** @public */
declare const MongoErrorLabel: Readonly<{
 ...
 * @category Error
 */
declare class MongoExpiredSessionError extends MongoAPIError {
  constructor(message?: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoGridFSChunkError extends MongoRuntimeError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoGridFSStreamError extends MongoRuntimeError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoInvalidArgumentError extends MongoAPIError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoKerberosError extends MongoRuntimeError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoMissingCredentialsError extends MongoAPIError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoMissingDependencyError extends MongoAPIError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoNetworkError extends MongoError {
  /* Excluded from this release type: [kBeforeHandshake] */
 ...
 */
declare class MongoNetworkTimeoutError extends MongoNetworkError {
 ...
 * @category Error
 */
declare class MongoNotConnectedError extends MongoAPIError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoParseError extends MongoDriverError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoRuntimeError extends MongoDriverError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoServerClosedError extends MongoAPIError {
  constructor(message?: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoServerError extends MongoError {
  codeName?: string;
 ...
 * @category Error
 */
declare class MongoServerSelectionError extends MongoSystemError {
 ...
 * @category Error
 */
declare class MongoSystemError extends MongoError {
 ...
 * @category Error
 */
declare class MongoTailableCursorError extends MongoAPIError {
  constructor(message?: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoTopologyClosedError extends MongoAPIError {
  constructor(message?: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoTransactionError extends MongoAPIError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoUnexpectedServerResponseError extends MongoRuntimeError {
  constructor(message: string);
  get name(): string;
}
 ...
 * @category Error
 */
declare class MongoWriteConcernError extends MongoServerError {
...
/** @public */
declare interface MonitorOptions extends Omit<ConnectionOptions, "id" | "generation" | "hostAddress"> {
  connectTimeoutMS: number;
  heartbeatFrequencyMS: number;
  minHeartbeatFrequencyMS: number;
}
 ...
 */
declare type NestedPaths<Type, Depth extends number[]> = Depth["length"] extends 8
  ? []
  : Type extends
      | string
      | number
 ...
 * https://docs.mongodb.com/manual/tutorial/query-embedded-documents/
 */
declare type NestedPathsOfType<TSchema, Type> = KeysOfAType<
  {
    [Property in Join<NestedPaths<TSchema, []>, ".">]: PropertyType<TSchema, Property>;
  },
  Type
...
/** @public */
declare type OnlyFieldsOfType<TSchema, FieldType = any, AssignableType = FieldType> = IsAny<
 ...
 */
declare type Projection<TSchema extends Document = Document> = Document;
...
{
  Promise_2 as Promise;
}

/** @public */
declare type PropertyType<Type, Property extends string> = string extends Property
  ? unknown
...
/** @public */
declare type SupportedNodeConnectionOptions = SupportedTLSConnectionOptions &
