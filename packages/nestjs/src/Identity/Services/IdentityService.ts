...
export class IdentityService {
  ...
  async create(id: string, alias: string, data: string, keys: PublicIdentityKeys): Promise<void> {
    await this.model.create({ id, alias, data, signature: keys.signature, vault: keys.vault });
  }
